-- Migración para crear tabla de logs de creación de libros
-- Permite monitorear en tiempo real el progreso de creación

CREATE TABLE IF NOT EXISTS public.book_creation_logs (
